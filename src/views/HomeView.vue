...
<template>
  ...
  >
    ...
    >
      <h1 class="text-3xl text-blue-800 font-bold">Welcome to Grocery Store</h1>
      <p>A place to find your fresh Grocery</p>
      <div class="button">
        <button
          @click="router.push('/item-list')"
          class="py-2 px-10 rounded text-slate-200 bg-green-950 my-2"
        >
          VISIT TO BUY
        </button>
      </div>
